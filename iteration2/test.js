...
// var extraArray = bc1.pendingTransactions.slice(7, 10);
// const displayArray = bc1.pendingTransactions.slice(0, 5);
// console.log(extraArray.length);
console.log(bc1.pendingTransactions.length);
bc1.pendingTransactions = bc1.pendingTransactions.slice(7,10);
console.log(bc1.pendingTransactions.length);
